      ...
      <div className="section-container relative z-10 py-12">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Location */}
            <div className="flex items-center gap-2 text-muted-foreground mt-6 justify-center lg:justify-start animate-fade-up-delay-2">
              <MapPin className="w-4 h-4" />
              <span className="text-sm">Sweden</span>
            </div>
          </div>
        </div>
